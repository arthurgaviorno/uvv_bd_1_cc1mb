CREATE SCHEMA elmasri AUTHORIZATION postgres-arthur;
...
CREATE TABLE `departamento` (
  ...
  CONSTRAINT departamento_UN UNIQUE  (nome_departamento)
  CONSTRAINT departamento_FK 
  FOREIGN KEY (cpf_gerente) 
  REFERENCES funcionarios (cpf_supervisor) 
);
